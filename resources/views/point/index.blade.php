...
@section('content')
    <div class="navbar-point mb-3">
        <div class="navbar-point-title">Добавление точки</div>
    </div>
    <form method="POST" action="{{ route('point.store') }}">
        @csrf
        <div class="container enter">
            @include('inc.messages')
            <label for="name" class="col-12 col-form-label text-center">Название точки</label>
            <div class="col-md-12">
    ...
    <div class="navbar-point mt-3 mb-3">
        <div class="navbar-point-title">Все точки</div>
    </div>
