...
@section('content')
    <div class="navbar-point mb-3">
        <div class="navbar-point-title">Настройка точки</div>
    </div>
    <h1 class="text-center">{{ $point->name }}</h1>
    <h1 class="text-center">Товар на точке</h1>
    <div class="container">
            ...
            <div class="setting-point mt-4">
                <div class="row text-center ">
                    ...
                    <div class="col-4 font-size-2">
                        ...
                        <a href="{{ route('point.stock', [$point->id, $product->id]) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
    ...
    <h1 class="text-center m-3">Товар на складе</h1>
    <div class="container">
            ...
            <div class="setting-point mt-4">
                <div class="row text-center ">
                    ...
                    <div class="col-4 font-size-2">
                        ...
                        <a href="{{ route('point.product.stock', [$point->id, $stock->id]) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                                class="bi bi-check-circle-fill green" viewBox="0 0 16 16">
                                <path
