...
@section('content')
    <div class="navbar-point mb-3">
        <div class="navbar-point-title">Добавление товара</div>
    </div>
    <form method="POST" action="{{ route('product.store') }}">
        @csrf
        <div class="container enter">
            @include('inc.messages')
            <label for="name" class="col-12 col-form-label text-center">Название</label>
            <div class="col-md-12">
            ...
            <label for="price" class="col-12 col-form-label text-center">Цена</label>
            <div class="col-md-12">
                ...
                <div class="col-12">
                    <button type="submit" class="enter-submit-green mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-check-circle-fill white point-success" viewBox="0 0 16 16">
                            <path
    ...
    <div class="navbar-point mt-3 mb-3">
        <div class="navbar-point-title">Весь товар</div>
    </div>
    <div class="container mb-6">
        @foreach ($products as $product)
            <div class="setting-product mt-4">
                                ...
                                <form method="post" action="{{ route('product.destroy', $product->id) }}">
                                    ...
                                    <button type="subbmit" class="btn p-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                            fill="currentColor" class="bi bi-x-circle-fill red p-0" viewBox="0 0 16 16">
                                            <path
