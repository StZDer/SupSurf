                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="patronymic" type="text"
                                        ...
                                        value="{{ old('patronymic') }}" required autocomplete="name" autofocus>
                            ...
                            <label for="role" class="col-12 col-form-label text-center">Выберите
                                роль</label>
                            ...
                            <div class="row mb-3">
                                <label for="point" class="col-md-4 col-form-label text-md-end">Выберите
                                    местоположение</label>

                                <select class="form-select" name="point" id="point">
                                    <option selected>Open this select menu</option>
                                    <option value="1">One</option>
                                    <option value="2">Two</option>
                                    <option value="3">Three</option>
