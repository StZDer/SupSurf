...
@section('content')
    <div class="navbar-statistics mb-3">
        <div class="navbar-statistics-title">Статистика</div>
    </div>
    <div class="container">
        <div class="setting-statistics mt-2">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-6">
                    <div class="text">Последний</div>
                </div>
                <div class="col-6">
                    {{-- {{ dd($last) }} --}}
                    <div class="text">
                        {{ intdiv($last, 60) }} ч. {{ $last % 60 }} м.
                    </div>
                </div>
            </div>
        </div>
        <div class="setting-statistics mt-2">
            <div class="row justify-content-center align-items-center h-100">
                ...
                <div class="col-6">
                    <div class="text">{{ intdiv($differenceSumToday, 60) }} ч. {{ $differenceSumToday % 60 }} м.</div>
                </div>
            </div>
        </div>
        <div class="setting-statistics mt-2">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-6">
                    <div class="text">Вчера</div>
                </div>
                <div class="col-6">
                    <div class="text">{{ intdiv($differenceSumYesterday, 60) }} ч. {{ $differenceSumYesterday % 60 }} м.
                    </div>
                </div>
            </div>
        </div>
        <div class="setting-statistics mt-2">
            <div class="row justify-content-center align-items-center h-100">
                ...
                <div class="col-6">
                    <div class="text">{{ intdiv($differenceSumWeek, 60) }} ч. {{ $differenceSumWeek % 60 }} м.</div>
                </div>
            </div>
        </div>
        <div class="setting-statistics mt-2">
            <div class="row justify-content-center align-items-center h-100">
                ...
                <div class="col-6">
                    <div class="text">{{ intdiv($differenceSumMonth, 60) }} ч. {{ $differenceSumMonth % 60 }} м.</div>
                </div>
            </div>
        </div>
        <div class="setting-statistics mt-2">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-6">
                    <div class="text">За год</div>
                </div>
                <div class="col-6">
                    <div class="text">{{ intdiv($differenceSumYear, 60) }} ч. {{ $differenceSumYear % 60 }} м.</div>
                </div>
            </div>
        </div>
    </div>
    <div class="navbar-statistics mb-3 mt-3">
        <div class="navbar-statistics-title">Разное</div>
    </div>
    <div class="container">
        <div class="setting-statistics-more mt-2 mb-3">
            <div class="row justify-content-center align-items-center h-100">
                <a href="{{ route('statistics.history') }}">
                    <div class="col-12">
                        <div class="text">История аренды</div>
                    </div>
                </a>
            </div>
        </div>
        <div class="setting-statistics-more mt-2 mb-3">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-12">
                    <div class="text">Свод правил проката сапов</div>
                </div>
            </div>
        </div>
        <div class="setting-statistics-more mt-2 mb-3">
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-12">
                    <div class="text">Правила техники безопасности</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="navbar-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-3 p-1">
                        <div class="statistics active-navbar p-2">
