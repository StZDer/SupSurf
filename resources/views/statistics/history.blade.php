...
@section('content')
    ...
    <div class="container">
        @foreach ($rents as $rent)
            <div class="text-center p-1">{{ Carbon\Carbon::parse($rent->end_date_time)->isoformat('DD.MM.YY') }}</div>
            <div class="setting-statistics mt-2">
                <div class="row justify-content-center align-items-center h-100">
                    <div class="col-4">
                        <div class="text">{{ Carbon\Carbon::parse($rent->start_date_time)->isoformat('DD.MM.YY') }}
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="text">с {{ Carbon\Carbon::parse($rent->start_date_time)->isoformat('HH:mm') }}
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="text">
                            {{-- {{ Carbon\Carbon::parse($rent->start_date_time)->diffInMinutes(Carbon\Carbon::parse($rent->end_date_time)) }} --}}
                            {{ intdiv(Carbon\Carbon::parse($rent->start_date_time)->diffInMinutes(Carbon\Carbon::parse($rent->end_date_time)), 60) }}
                            ч.
                            {{ Carbon\Carbon::parse($rent->start_date_time)->diffInMinutes(Carbon\Carbon::parse($rent->end_date_time)) % 60 }}
                            м.
                        </div>
                    </div>
                    <br>
                    <div class="col-4">
                        <div class="text">{{ $rent->user->login }}</div>
                    </div>
                    <div class="col-4">
                        <div class="text">{{ $rent->product->name }}</div>
                    </div>
                    <div class="col-4">
                        <div class="text">{{ $rent->payment }} р.</div>
                    </div>
                </div>
            </div>
        @endforeach
