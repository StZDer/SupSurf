...
@section('content')
    <div class="navbar-point mb-3">
        <div class="navbar-point-title">Добавления пользователя</div>
    </div>
    <form method="POST" action="{{ route('register') }}">
        @csrf
        <div class="container enter">
            @include('inc.messages')
            <label for="name" class="col-12 col-form-label text-center">Имя</label>
            <div class="col-md-12">
            ...
            <label for="surname" class="col-12 col-form-label text-center">Фамилия</label>
            ...
            <label for="patronymic" class="col-12 col-form-label text-center">Отчество</label>
            ...
            <label for="login" class="col-12 col-form-label text-center">Логин</label>
            ...
            <label for="password" class="col-12 col-form-label text-center">Пароль</label>
            ...
            <label for="password-confirm" class="col-12 col-form-label text-center">Повторите
                пароль</label>
            <div class="col-md-12">
            ...
            <label for="role_id" class="col-12 col-form-label text-center">Выберите
                роль</label>
            ...
            <label for="point_id" class="col-12 col-form-label text-center">Выберите
            ...
            <div class="row mb-0">
                <div class="col-12">
                    <button type="submit" class="enter-submit-green mt-2">
                        Зарегистрировать
                    </button>
                </div>
            </div>
    ...
    <div class="navbar-point mt-2 mb-3">
        <div class="navbar-point-title">Все пользователи</div>
    </div>
    <div class="container mb-6">
        @foreach ($users as $user)
            <div class="setting-point mt-4">
                <div class="row text-center ">
                    <div class="col-4">{{ $user->surname }}</div>
                    <div class="col-4">{{ $user->login }}</div>
                    <div class="col-4 font-size-2">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <form method="post" action="{{ route('user.destroy', $user->id) }}">
                                    @method('DELETE')
                                    @csrf
                                    <button type="subbmit" class="btn p-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            fill="currentColor" class="bi bi-x-circle-fill red" viewBox="0 0 16 16">
                                            <path
        ...
        <div class="navbar-bottom">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-3 p-1">
                        <div class="back active-navbar p-2">
                            <a href="{{ route('home') }}">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
