...
@section('content')
    ...
    <form method="POST" action="{{ route('user.update', $user->id) }}">
        @csrf
        @method('PUT')
        <div class="container enter mb-6">
            ...
            <div class="col-md-12">
                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror"
                    name="surname" value="{{ $user->surname }}" autocomplete="name" autofocus>
            ...
            <div class="col-md-12">
                <input id="patronymic" type="text" class="form-control @error('patronymic') is-invalid @enderror"
                    name="patronymic" value="{{ $user->patronymic }}" autocomplete="name" autofocus>
            ...
            <div class="col-md-12">
                <input id="login" type="login" class="form-control @error('login') is-invalid @enderror"
                    name="login" value="{{ $user->login }}" autocomplete="login">
            ...
            <select class="form-select" name="point_id" id="point_id">
                @foreach ($points as $point)
                    <option @if ($point->id == $user->point_id) selected @endif value="{{ $point->id }}">
                        {{ $point->name }}</option>
                @endforeach
            </select>
            @error('point_id')
